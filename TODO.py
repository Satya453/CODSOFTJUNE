...
def main():
    ...
    entry_task = tk.Entry(root,background="light yellow",width=50)
    entry_task.pack(pady=20)
    button_add_task = tk.Button(root,text="Add Task",background="pink",command=add_task)
    button_add_task.pack(side=tk.LEFT,padx=15)
    button_delete_task = tk.Button(root,text="Delete Task",background="pink" ,command=delete_task)
    button_delete_task.pack(side=tk.LEFT,padx=15)
    button_edit_task = tk.Button(root,text="Edit Task",background="pink",command=edit_task)
    button_edit_task.pack(side=tk.LEFT,padx=15)
    root.mainloop()
